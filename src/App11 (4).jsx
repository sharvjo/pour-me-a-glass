...
Food pairing is top priority. Be specific — not "White Burgundy" but "Chablis Premier Cru", not "Spanish Red" but "Ribera del Duero Tempranillo". The style name and region should be precise enough that someone could walk into a wine shop and know exactly what to ask for. The description should directly reference their preferences and food — don't be generic.

The 3 picks must be:
1. tier "easy_find" — approachable, crowd-pleasing, widely available style that still fits their ask precisely
2. tier "famous" — a well-known classic that shows up on good restaurant lists, specific to their preferences
3. tier "sommelier" — something more interesting or unexpected a wine bar person would recommend, that still fits their ask

Return ONLY this JSON, no markdown:
{"status":"match","picks":[{"style":"Chablis Premier Cru","region":"Chardonnay, Burgundy, France","description":"2 sentences directly referencing their preferences and food pairing — specific, not generic","tier":"easy_find","producers":["Producer 1","Producer 2","Producer 3","Producer 4"]},{"style":"...","region":"...","description":"...","tier":"famous","producers":["...","...","...","..."]},{"style":"...","region":"...","description":"...","tier":"sommelier","producers":["...","...","...","..."]}]}`;
    }
  };
